...
export type ProductPriceWhereInput = {
  ...
  priceCents?: Prisma.IntFilter<"ProductPrice"> | number
  currency?: Prisma.EnumCurrencyFilter<"ProductPrice"> | $Enums.Currency
...
export type ProductPriceScalarWhereWithAggregatesInput = {
  ...
  priceCents?: Prisma.IntWithAggregatesFilter<"ProductPrice"> | number
  currency?: Prisma.EnumCurrencyWithAggregatesFilter<"ProductPrice"> | $Enums.Currency
...
export type ProductPriceOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"productId" | "priceCents" | "currency" | "updatedAt", ExtArgs["result"]["productPrice"]>
...
export interface ProductPriceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const productPriceWithProductIdOnly = await prisma.productPrice.findMany({ select: { productId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ProductPrices and only return the `productId`
   * const productPriceWithProductIdOnly = await prisma.productPrice.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ProductPrices and only return the `productId`
   * const productPriceWithProductIdOnly = await prisma.productPrice.updateManyAndReturn({
   *   select: { productId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ProductPriceFieldRefs {
  ...
  readonly priceCents: Prisma.FieldRef<"ProductPrice", 'Int'>
  readonly currency: Prisma.FieldRef<"ProductPrice", 'Currency'>
